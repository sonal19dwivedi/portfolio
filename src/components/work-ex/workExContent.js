export const MY_WORK_EX = [
  ...
  },
  {
    ...
    details: (
      <ul>
        <li>Worked as a Teaching Assistant for the course Software Construction(Undergraduate second-year course).</li>
        <li>
  ...
  },
  {
    ...
    details: (
      <ul>
        <li>
          Worked as a teaching assistant for the courses Software Construction and Professional Practice in Computer Science (Undergraduate
          second-year courses).
        </li>
        <li>
          My responsibilities included guiding students for their practical lab and answering questions related to UML, regular expressions, BNF, and
          basic theory of grammars and parsing, and parser generators.
        </li>
      </ul>
    ),
  },
  {
    ...
    details: (
      <ul>
        <li>
          Taught practical experiments of digital computer design to execute a given instruction set, the CPU and the CPU control using QUARTUS II and
          FPGA board to the students by taking Computer Architecture labs of second-year students as a Teaching Assistant at the University of Ottawa.
        </li>
      </ul>
    ),
  },
  {
    timeline: "Dec 2017 - Jul 2019",
